/**
 * Icons — thin line, 1.5px stroke, rounded caps/joins. Lucide / Phosphor-light
 * feel. Stroke is `currentColor` so callers control hue; size defaults to 18.
 * Ported verbatim from design/project/icons.jsx.
 */

import type { ReactNode, SVGProps } from 'react'

type IconProps = Omit<SVGProps<SVGSVGElement>, 'fill' | 'width' | 'height'> & {
  size?: number
  fill?: string
}

function makeIcon(d: ReactNode, viewBox = '0 0 24 24') {
  return function Icon({ size = 18, fill, ...rest }: IconProps) {
    return (
      <svg
        width={size}
        height={size}
...
export const MicOff = makeIcon(
  <>
    <path d="M5 11a7 7 0 0 0 11.7 5.2M12 18v3M3 3l18 18" />
    <path d="M9 5.4A3 3 0 0 1 15 6v4M15 11a3 3 0 0 1-5.1 2.1" />
  </>,
)
...
export const SpeakerOff = makeIcon(
  <>
    <path d="M5 9h3l5-4v14l-5-4H5z" />
...
export const Stethoscope = makeIcon(
  <>
    ...
    <path d="M9 13v2a4 4 0 0 0 8 0v-1" />
...
export const Sun = makeIcon(
  <>
    ...
    <path d="M12 3v2M12 19v2M5 12H3M21 12h-2M6 6l-1.5-1.5M19.5 19.5L18 18M6 18l-1.5 1.5M19.5 4.5L18 6" />
  </>,
)
